      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-16">
          {products.map((product) => (
            <Fade direction='down'>
              <article className="h-[350px] relative flex flex-col overflow-hidden rounded-lg border transition-all duration-300 hover:scale-105" key={product.id}>
                ...
                <div className="my-4 mx-auto flex w-10/12 flex-col items-start justify-between">
                  ...
                  <div className="mb-2 flex">
                    <p className="mr-3 text-sm font-semibold">
                      {new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(product.price - product.price * product.discount)}
                    </p>
